...
export const componentStorybookEntries: ComponentStorybookEntry[] = [
  {
    ...
    description:
      'Safari/iOS visual story for custom Popover+Calendar pickers and native temporal inputs (native marked DO NOT USE). Tests form layouts, modal forms, and drawer forms in light and dark mode.',
    icon: Calendar,
    badges: ['Safari', 'iOS', 'Dark Mode', 'Modal', 'Drawer'],
    status: 'experimental',
    bestPractices: [
      ...
      'Test date pickers inside Dialog and Drawer forms — common Safari failure surface.',
    ],
    practicesToAvoid: [
      ...
      'Opening date picker popovers inside modals/drawers without modal Popover — breaks on iOS Safari.',
    ],
  },
];
