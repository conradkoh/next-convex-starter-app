...
vi.mock('@tiptap/react', () => ({ useEditor: () => ({ chain: () => ({ focus: () => ({ run: vi.fn() }) }) }), EditorContent: ({ className }: { className?: string }) => <div data-testid="markdown-editor-content" className={className} /> }));
